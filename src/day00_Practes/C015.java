...
*/
        String strilk = "$13.99";
        String striki = "$10.55";
         strilk= strilk.replaceAll("\\W", "");
         striki=striki.replaceAll("\\W", "");
        double sayı = Double.parseDouble(strilk);
        double sayı2 = Double.parseDouble(striki);
        System.out.println("$"+(sayı + sayı2)/100);
    }
